...
class Project(Base):
    ...
    rights_tag = Column(String(100), nullable=True)
...
class GitHubAccount(Base):
    ...
    sync_logs = relationship("GitHubSyncLog", back_populates="account", cascade="all, delete-orphan")
...
class GitHubSyncLog(Base):
    ...
    account = relationship("GitHubAccount", back_populates="sync_logs")
